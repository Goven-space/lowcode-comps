import ColorfulButtonMeta from '/test/lowcode-comps/your-material-name/lowcode/colorful-button/meta'
import ColorfulInputMeta from '/test/lowcode-comps/your-material-name/lowcode/colorful-input/meta'
import OrganizationSelectedMeta from '/test/lowcode-comps/your-material-name/lowcode/organization-selected/meta'
...
const componentMetas = [ColorfulButtonMeta,ColorfulInputMeta,OrganizationSelectedMeta];
const components = [];
const npmInfo = {};
